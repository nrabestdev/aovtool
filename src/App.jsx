...
function App() {
  ...
  const handleSubmit = async () => {
    if (!why) {
      ...
      toast.error("NHẬP ID GỬI TÀI KHOẢN !");
    } else {
      ...
      await axios
        ...
        .then((response) => {
          toast.update(id, {
            render: "Đang thử nghiệm tính năng!",
            type: "success",
            isLoading: false,
            autoClose: 2000,
          });
        ...
        .catch((err) => {
          toast.update(id, {
            render: "Không thành công , tải lại trang nhé!",
            type: "error",
            isLoading: false,
            autoClose: 2000,
          });
      ...
      >
        ...
        >
          <Container maxWidth="sm">
            ...
            <Typography variant="body2">Số lượng luôn phải là bội của 10</Typography>
            <Typography variant="body3">Không thoát trang trong quá trình gửi vì có thể làm thiếu số lượng</Typography>
            <Typography variant="body4">Tướng code đúng bằng số thứ tự mà tướng ra đời</Typography>
            <Typography variant="body5">Skin code thì nhập số thứ tự mà tướng ra đời và số thứ tự mà skin ra đời của tướng </Typography>
